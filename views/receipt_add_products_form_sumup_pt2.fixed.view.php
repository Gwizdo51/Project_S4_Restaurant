            ...
            <div class="modal-footer">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6 d-grid">
                            <input type="submit" class="btn btn-success py-5 fs-4" name="cancel_order" value="OK">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6 d-grid">
                            <input type="submit" class="btn btn-success py-5 fs-4" name="confirm_order" value="OK">
                        </div>
                    </div>
                </div>
            </div>
